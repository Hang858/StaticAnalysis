...
.method private a(Ljava/util/concurrent/ExecutorService;Ljava/util/List;Ljava/lang/String;Lcom/huawei/hms/framework/network/grs/e/c;)Lcom/huawei/hms/framework/network/grs/g/d;
    ...
    new-instance v16, Lcom/huawei/hms/framework/network/grs/g/a;
    ...
    invoke-virtual/range {v16 .. v16}, Lcom/huawei/hms/framework/network/grs/g/a;->g()Ljava/util/concurrent/Callable;
    ...
    invoke-static {v15, v0}, Lcom/huawei/hms/framework/common/Logger;->i(Ljava/lang/String;Ljava/lang/Object;)V
    :try_end_1
    ...
    :catch_4
    :goto_1
    const-string v0, "the wait timed out"

    invoke-static {v15, v0}, Lcom/huawei/hms/framework/common/Logger;->w(Ljava/lang/String;Ljava/lang/Object;)V
    ...
    :goto_2
    const-string v1, "the current thread was interrupted while waiting"

    invoke-static {v15, v1, v0}, Lcom/huawei/hms/framework/common/Logger;->w(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    :goto_3
    const-string v1, "the computation threw an ExecutionException"
    ...
    const-string v0, "needBreak is true so need break current circulation"

    invoke-static {v15, v0}, Lcom/huawei/hms/framework/common/Logger;->v(Ljava/lang/String;Ljava/lang/Object;)V
...
.method private b(Lcom/huawei/hms/framework/network/grs/g/d;)Lcom/huawei/hms/framework/network/grs/g/d;
    ...
    iget-object v1, p0, Lcom/huawei/hms/framework/network/grs/g/c;->e:Ljava/util/Map;
...
.method private b(Ljava/util/concurrent/ExecutorService;Ljava/lang/String;Lcom/huawei/hms/framework/network/grs/e/c;)Lcom/huawei/hms/framework/network/grs/g/d;
    ...
    invoke-static {v3, v6, v5}, Lcom/huawei/hms/framework/common/Logger;->v(Ljava/lang/String;Ljava/lang/String;[Ljava/lang/Object;)V
...
.method private c()V
    ...
    invoke-static {v1, v4}, Lcom/huawei/hms/framework/common/Logger;->w(Ljava/lang/String;Ljava/lang/Object;)V

    goto :goto_0

    :cond_2
    invoke-direct {p0, v3, v4}, Lcom/huawei/hms/framework/network/grs/g/c;->b(Ljava/lang/String;Ljava/lang/String;)V

    invoke-direct {p0, v0, v4}, Lcom/huawei/hms/framework/network/grs/g/c;->a(Ljava/lang/String;Ljava/lang/String;)V
...
.method public a(Ljava/util/concurrent/ExecutorService;Ljava/lang/String;Lcom/huawei/hms/framework/network/grs/e/c;)Lcom/huawei/hms/framework/network/grs/g/d;
    ...
    iget-object v1, p0, Lcom/huawei/hms/framework/network/grs/g/c;->i:Ljava/util/List;
    ...
    invoke-virtual {v1}, Lcom/huawei/hms/framework/network/grs/g/k/d;->d()I
    ...
    :goto_0
    new-instance v3, Lcom/huawei/hms/framework/network/grs/g/c$a;

    invoke-direct {v3, p0, p1, p2, p3}, Lcom/huawei/hms/framework/network/grs/g/c$a;-><init>(Lcom/huawei/hms/framework/network/grs/g/c;Ljava/util/concurrent/ExecutorService;Ljava/lang/String;Lcom/huawei/hms/framework/network/grs/e/c;)V
    ...
    const-string p2, "{submitExcutorTaskWithTimeout} catch Exception"

    goto :goto_1

    :catch_1
    const-string p1, "{submitExcutorTaskWithTimeout} the wait timed out"
    ...
    const-string p2, "{submitExcutorTaskWithTimeout} the current thread was interrupted while waiting"
    ...
    const-string p2, "{submitExcutorTaskWithTimeout} the computation threw an ExecutionException"
    ...
    :catch_4
    const-string p1, "{submitExcutorTaskWithTimeout} the computation was cancelled"
