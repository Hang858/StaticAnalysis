...
.method constructor <init>(Lj$/util/S;JJ)V
    ...
    iput-object p1, p0, Lj$/util/stream/N3;->a:Lj$/util/S;
    ...
    :goto_0
    iput-boolean v2, p0, Lj$/util/stream/N3;->b:Z
    ...
    iput-object v0, p0, Lj$/util/stream/N3;->d:Ljava/util/concurrent/atomic/AtomicLong;
...
.method constructor <init>(Lj$/util/S;Lj$/util/stream/N3;)V
    ...
    iget-boolean p1, p2, Lj$/util/stream/N3;->b:Z

    iput-boolean p1, p0, Lj$/util/stream/N3;->b:Z

    iget-object p1, p2, Lj$/util/stream/N3;->d:Ljava/util/concurrent/atomic/AtomicLong;

    iput-object p1, p0, Lj$/util/stream/N3;->d:Ljava/util/concurrent/atomic/AtomicLong;

    iget-wide p1, p2, Lj$/util/stream/N3;->c:J
...
.method protected final j(J)J
    ...
    :cond_0
    iget-object v0, p0, Lj$/util/stream/N3;->d:Ljava/util/concurrent/atomic/AtomicLong;
    ...
    iget-object v6, p0, Lj$/util/stream/N3;->d:Ljava/util/concurrent/atomic/AtomicLong;
    ...
    :cond_3
    iget-boolean v6, p0, Lj$/util/stream/N3;->b:Z
    ...
    :cond_4
    iget-wide p1, p0, Lj$/util/stream/N3;->c:J
...
.method public bridge synthetic trySplit()Lj$/util/F;
    ...
    invoke-virtual {p0}, Lj$/util/stream/N3;->trySplit()Lj$/util/S;
...
.method public final trySplit()Lj$/util/S;
    ...
    :cond_1
    invoke-virtual {p0, v0}, Lj$/util/stream/N3;->l(Lj$/util/S;)Lj$/util/S;
