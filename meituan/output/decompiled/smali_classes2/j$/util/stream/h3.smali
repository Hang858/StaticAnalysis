...
.method public final synthetic collect(Ljava/util/function/Supplier;Ljava/util/function/BiConsumer;Ljava/util/function/BiConsumer;)Ljava/lang/Object;
    ...
    invoke-static {p2}, Lj$/util/function/a;->a(Ljava/util/function/BiConsumer;)Lj$/util/function/BiConsumer;
...
.method public final synthetic flatMapToDouble(Ljava/util/function/Function;)Ljava/util/stream/DoubleStream;
    ...
    invoke-interface {v0, p1}, Lj$/util/stream/Stream;->y(Lj$/util/function/Function;)Lj$/util/stream/M;
...
.method public final synthetic flatMapToInt(Ljava/util/function/Function;)Ljava/util/stream/IntStream;
    ...
    invoke-interface {v0, p1}, Lj$/util/stream/Stream;->e(Lj$/util/function/Function;)Lj$/util/stream/q0;
...
.method public final synthetic flatMapToLong(Ljava/util/function/Function;)Ljava/util/stream/LongStream;
    ...
    invoke-interface {v0, p1}, Lj$/util/stream/Stream;->S(Lj$/util/function/Function;)Lj$/util/stream/A0;
...
.method public final synthetic mapToDouble(Ljava/util/function/ToDoubleFunction;)Ljava/util/stream/DoubleStream;
    ...
    invoke-interface {v0, p1}, Lj$/util/stream/Stream;->e0(Lj$/util/function/R0;)Lj$/util/stream/M;
...
.method public final synthetic mapToInt(Ljava/util/function/ToIntFunction;)Ljava/util/stream/IntStream;
    ...
    invoke-interface {v0, p1}, Lj$/util/stream/Stream;->l(Lj$/util/function/U0;)Lj$/util/stream/q0;
...
.method public final synthetic mapToLong(Ljava/util/function/ToLongFunction;)Ljava/util/stream/LongStream;
    ...
    invoke-interface {v0, p1}, Lj$/util/stream/Stream;->b0(Lj$/util/function/ToLongFunction;)Lj$/util/stream/A0;
...
.method public final synthetic reduce(Ljava/lang/Object;Ljava/util/function/BiFunction;Ljava/util/function/BinaryOperator;)Ljava/lang/Object;
    ...
    invoke-static {p3}, Lj$/util/function/f;->a(Ljava/util/function/BinaryOperator;)Lj$/util/function/h;

    move-result-object p3

    invoke-interface {v0, p1, p2, p3}, Lj$/util/stream/Stream;->w(Ljava/lang/Object;Lj$/util/function/BiFunction;Lj$/util/function/h;)Ljava/lang/Object;
...
.method public final synthetic reduce(Ljava/lang/Object;Ljava/util/function/BinaryOperator;)Ljava/lang/Object;
    ...
    invoke-static {p2}, Lj$/util/function/f;->a(Ljava/util/function/BinaryOperator;)Lj$/util/function/h;

    move-result-object p2

    invoke-interface {v0, p1, p2}, Lj$/util/stream/Stream;->i0(Ljava/lang/Object;Lj$/util/function/h;)Ljava/lang/Object;
...
.method public final synthetic reduce(Ljava/util/function/BinaryOperator;)Ljava/util/Optional;
    ...
    invoke-static {p1}, Lj$/util/function/f;->a(Ljava/util/function/BinaryOperator;)Lj$/util/function/h;

    move-result-object p1

    invoke-interface {v0, p1}, Lj$/util/stream/Stream;->q(Lj$/util/function/h;)Lj$/util/Optional;
