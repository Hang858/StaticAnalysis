...
.method static constructor <clinit>()V
    ...
    invoke-static {v1}, Lj$/util/stream/k3;->j(Lj$/util/stream/j3;)Lj$/util/stream/i3;

    move-result-object v2

    sget-object v3, Lj$/util/stream/j3;->STREAM:Lj$/util/stream/j3;

    invoke-virtual {v2, v3}, Lj$/util/stream/i3;->b(Lj$/util/stream/j3;)Lj$/util/stream/i3;

    sget-object v4, Lj$/util/stream/j3;->OP:Lj$/util/stream/j3;

    invoke-virtual {v2, v4}, Lj$/util/stream/i3;->c(Lj$/util/stream/j3;)Lj$/util/stream/i3;

    const-string v5, "DISTINCT"

    const/4 v6, 0x0

    invoke-direct {v0, v5, v6, v6, v2}, Lj$/util/stream/k3;-><init>(Ljava/lang/String;IILj$/util/stream/i3;)V
    ...
    invoke-virtual {v5, v3}, Lj$/util/stream/i3;->b(Lj$/util/stream/j3;)Lj$/util/stream/i3;

    invoke-virtual {v5, v4}, Lj$/util/stream/i3;->c(Lj$/util/stream/j3;)Lj$/util/stream/i3;

    const-string v7, "SORTED"

    const/4 v8, 0x1

    invoke-direct {v2, v7, v8, v8, v5}, Lj$/util/stream/k3;-><init>(Ljava/lang/String;IILj$/util/stream/i3;)V

    sput-object v2, Lj$/util/stream/k3;->SORTED:Lj$/util/stream/k3;

    new-instance v5, Lj$/util/stream/k3;

    invoke-static {v1}, Lj$/util/stream/k3;->j(Lj$/util/stream/j3;)Lj$/util/stream/i3;

    move-result-object v7

    invoke-virtual {v7, v3}, Lj$/util/stream/i3;->b(Lj$/util/stream/j3;)Lj$/util/stream/i3;

    invoke-virtual {v7, v4}, Lj$/util/stream/i3;->c(Lj$/util/stream/j3;)Lj$/util/stream/i3;

    sget-object v9, Lj$/util/stream/j3;->TERMINAL_OP:Lj$/util/stream/j3;

    invoke-virtual {v7, v9}, Lj$/util/stream/i3;->a(Lj$/util/stream/j3;)Lj$/util/stream/i3;

    sget-object v10, Lj$/util/stream/j3;->UPSTREAM_TERMINAL_OP:Lj$/util/stream/j3;

    invoke-virtual {v7, v10}, Lj$/util/stream/i3;->a(Lj$/util/stream/j3;)Lj$/util/stream/i3;

    const-string v11, "ORDERED"

    const/4 v12, 0x2

    invoke-direct {v5, v11, v12, v12, v7}, Lj$/util/stream/k3;-><init>(Ljava/lang/String;IILj$/util/stream/i3;)V

    sput-object v5, Lj$/util/stream/k3;->ORDERED:Lj$/util/stream/k3;

    new-instance v7, Lj$/util/stream/k3;

    invoke-static {v1}, Lj$/util/stream/k3;->j(Lj$/util/stream/j3;)Lj$/util/stream/i3;

    move-result-object v11

    invoke-virtual {v11, v3}, Lj$/util/stream/i3;->b(Lj$/util/stream/j3;)Lj$/util/stream/i3;

    invoke-virtual {v11, v4}, Lj$/util/stream/i3;->a(Lj$/util/stream/j3;)Lj$/util/stream/i3;

    const-string v13, "SIZED"

    const/4 v14, 0x3

    invoke-direct {v7, v13, v14, v14, v11}, Lj$/util/stream/k3;-><init>(Ljava/lang/String;IILj$/util/stream/i3;)V

    sput-object v7, Lj$/util/stream/k3;->SIZED:Lj$/util/stream/k3;

    new-instance v11, Lj$/util/stream/k3;

    invoke-static {v4}, Lj$/util/stream/k3;->j(Lj$/util/stream/j3;)Lj$/util/stream/i3;

    move-result-object v13

    invoke-virtual {v13, v9}, Lj$/util/stream/i3;->b(Lj$/util/stream/j3;)Lj$/util/stream/i3;
    ...
    invoke-direct {v11, v15, v14, v12, v13}, Lj$/util/stream/k3;-><init>(Ljava/lang/String;IILj$/util/stream/i3;)V

    sput-object v11, Lj$/util/stream/k3;->SHORT_CIRCUIT:Lj$/util/stream/k3;

    const/4 v12, 0x5

    new-array v12, v12, [Lj$/util/stream/k3;
    ...
    sput-object v12, Lj$/util/stream/k3;->v:[Lj$/util/stream/k3;

    invoke-static {v1}, Lj$/util/stream/k3;->c(Lj$/util/stream/j3;)I

    move-result v0

    sput v0, Lj$/util/stream/k3;->f:I

    invoke-static {v3}, Lj$/util/stream/k3;->c(Lj$/util/stream/j3;)I

    move-result v0

    sput v0, Lj$/util/stream/k3;->g:I

    invoke-static {v4}, Lj$/util/stream/k3;->c(Lj$/util/stream/j3;)I

    move-result v0

    sput v0, Lj$/util/stream/k3;->h:I

    invoke-static {v9}, Lj$/util/stream/k3;->c(Lj$/util/stream/j3;)I

    invoke-static {v10}, Lj$/util/stream/k3;->c(Lj$/util/stream/j3;)I
...
.method private constructor <init>(Ljava/lang/String;IILj$/util/stream/i3;)V
    ...
    iget-object v3, p4, Lj$/util/stream/i3;->a:Ljava/util/Map;
    ...
    :cond_0
    iget-object p1, p4, Lj$/util/stream/i3;->a:Ljava/util/Map;

    .line 2
    iput-object p1, p0, Lj$/util/stream/k3;->a:Ljava/util/Map;
...
.method private static c(Lj$/util/stream/j3;)I
    .locals 6
...
.method private static j(Lj$/util/stream/j3;)Lj$/util/stream/i3;
    .locals 3
    ...
    invoke-direct {v0, v1}, Lj$/util/stream/i3;-><init>(Ljava/util/Map;)V

    invoke-virtual {v0, p0}, Lj$/util/stream/i3;->b(Lj$/util/stream/j3;)Lj$/util/stream/i3;
