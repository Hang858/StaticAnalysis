...
# instance fields
.field private final a:Lj$/util/stream/J0;
...
.field private final e:Lj$/util/stream/w2;

.field private final f:Lj$/util/stream/d0;

.field private g:Lj$/util/stream/V0;


# direct methods
.method protected constructor <init>(Lj$/util/stream/J0;Lj$/util/S;Lj$/util/stream/w2;)V
    .locals 2
    ...
    iput-object p1, p0, Lj$/util/stream/d0;->a:Lj$/util/stream/J0;
    ...
    iput-object p3, p0, Lj$/util/stream/d0;->e:Lj$/util/stream/w2;
...
.method constructor <init>(Lj$/util/stream/d0;Lj$/util/S;Lj$/util/stream/d0;)V
    ...
    iget-object v0, p1, Lj$/util/stream/d0;->a:Lj$/util/stream/J0;

    iput-object v0, p0, Lj$/util/stream/d0;->a:Lj$/util/stream/J0;
    ...
    iget-object p1, p1, Lj$/util/stream/d0;->e:Lj$/util/stream/w2;

    iput-object p1, p0, Lj$/util/stream/d0;->e:Lj$/util/stream/w2;
...
.method public final compute()V
    ...
    iget-object v2, v4, Lj$/util/stream/d0;->a:Lj$/util/stream/J0;

    invoke-virtual {v2, v0}, Lj$/util/stream/J0;->Y0(Lj$/util/S;)J

    move-result-wide v5

    invoke-virtual {v2, v5, v6, v1}, Lj$/util/stream/J0;->q1(JLj$/util/function/IntFunction;)Lj$/util/stream/N0;

    move-result-object v1

    iget-object v2, v4, Lj$/util/stream/d0;->a:Lj$/util/stream/J0;

    invoke-virtual {v2, v1, v0}, Lj$/util/stream/J0;->v1(Lj$/util/stream/w2;Lj$/util/S;)Lj$/util/stream/w2;

    invoke-interface {v1}, Lj$/util/stream/N0;->b()Lj$/util/stream/V0;

    move-result-object v0

    iput-object v0, v4, Lj$/util/stream/d0;->g:Lj$/util/stream/V0;
...
.method public final onCompletion(Ljava/util/concurrent/CountedCompleter;)V
    ...
    iget-object p1, p0, Lj$/util/stream/d0;->g:Lj$/util/stream/V0;

    const/4 v0, 0x0

    if-eqz p1, :cond_0

    iget-object v1, p0, Lj$/util/stream/d0;->e:Lj$/util/stream/w2;

    invoke-interface {p1, v1}, Lj$/util/stream/V0;->a(Lj$/util/function/Consumer;)V

    iput-object v0, p0, Lj$/util/stream/d0;->g:Lj$/util/stream/V0;
    ...
    iget-object v1, p0, Lj$/util/stream/d0;->a:Lj$/util/stream/J0;

    iget-object v2, p0, Lj$/util/stream/d0;->e:Lj$/util/stream/w2;

    invoke-virtual {v1, v2, p1}, Lj$/util/stream/J0;->v1(Lj$/util/stream/w2;Lj$/util/S;)Lj$/util/stream/w2;
