...
.method public final g(Ljava/util/Map;Lj$/time/format/F;)Lj$/time/chrono/b;
    .locals 15
    ...
    invoke-virtual {v2, v9, v10}, Lj$/time/temporal/a;->p(J)J
    ...
    invoke-virtual {v2, v11, v12}, Lj$/time/temporal/a;->o(J)I
    ...
    invoke-static {v2, v10, v10}, Lj$/time/LocalDate;->y(III)Lj$/time/LocalDate;

    move-result-object v2

    invoke-virtual {v2, v6, v7}, Lj$/time/LocalDate;->D(J)Lj$/time/LocalDate;

    move-result-object v2

    invoke-virtual {v2, v0, v1}, Lj$/time/LocalDate;->C(J)Lj$/time/LocalDate;
    ...
    invoke-virtual {v3, v4, v5}, Lj$/time/temporal/a;->o(J)I
    ...
    invoke-virtual {v9, v4, v5}, Lj$/time/temporal/a;->o(J)I
    ...
    :cond_11
    :goto_4
    invoke-virtual {v1, v10}, Lj$/time/m;->q(Z)I
    ...
    :cond_13
    invoke-static {v2, v3, v0}, Lj$/time/LocalDate;->y(III)Lj$/time/LocalDate;
    ...
    .line 14
    invoke-virtual {v2, v11, v12, v3}, Lj$/time/LocalDate;->B(JLj$/time/temporal/x;)Lj$/time/LocalDate;
    ...
    .line 16
    invoke-virtual {v2, v13, v14, v3}, Lj$/time/LocalDate;->B(JLj$/time/temporal/x;)Lj$/time/LocalDate;
    ...
    .line 18
    invoke-virtual {v2, v0, v1, v3}, Lj$/time/LocalDate;->B(JLj$/time/temporal/x;)Lj$/time/LocalDate;
    ...
    .line 25
    invoke-static {v2, v4, v10}, Lj$/time/LocalDate;->y(III)Lj$/time/LocalDate;
    ...
    .line 27
    invoke-virtual {v2, v5, v6, v0}, Lj$/time/LocalDate;->B(JLj$/time/temporal/x;)Lj$/time/LocalDate;
    ...
    invoke-virtual {v0, v3}, Lj$/time/LocalDate;->f(Lj$/time/temporal/o;)I
    ...
    .line 33
    invoke-virtual/range {v0 .. v7}, Lj$/time/chrono/a;->c(Lj$/time/chrono/b;JJJ)Lj$/time/chrono/b;
    ...
    .line 42
    invoke-virtual {v2, v5, v6, v7}, Lj$/time/LocalDate;->B(JLj$/time/temporal/x;)Lj$/time/LocalDate;

    move-result-object v2

    .line 43
    invoke-static {v0}, Lj$/time/e;->p(I)Lj$/time/e;

    move-result-object v0

    invoke-static {v0}, Lj$/lang/a;->h(Lj$/time/e;)Lj$/time/temporal/m;

    move-result-object v0

    invoke-virtual {v2, v0}, Lj$/time/LocalDate;->J(Lj$/time/temporal/m;)Lj$/time/chrono/b;
    ...
    invoke-virtual {v1, v3}, Lj$/time/LocalDate;->f(Lj$/time/temporal/o;)I
    ...
    .line 47
    invoke-static {v2, v10}, Lj$/time/LocalDate;->A(II)Lj$/time/LocalDate;
    ...
    .line 52
    invoke-static {v2, v0}, Lj$/time/LocalDate;->A(II)Lj$/time/LocalDate;
    ...
    .line 56
    invoke-static {v7, v10}, Lj$/time/LocalDate;->A(II)Lj$/time/LocalDate;
    ...
    .line 58
    invoke-virtual {v0, v1, v2, v5}, Lj$/time/LocalDate;->B(JLj$/time/temporal/x;)Lj$/time/LocalDate;
    ...
    .line 60
    invoke-virtual {v0, v3, v4, v1}, Lj$/time/LocalDate;->B(JLj$/time/temporal/x;)Lj$/time/LocalDate;
    ...
    .line 67
    invoke-virtual {v4, v5, v6, v0}, Lj$/time/LocalDate;->B(JLj$/time/temporal/x;)Lj$/time/LocalDate;
    ...
    invoke-virtual {v0, v2}, Lj$/time/LocalDate;->f(Lj$/time/temporal/o;)I
    ...
    .line 80
    invoke-virtual {v4, v5, v6, v3}, Lj$/time/LocalDate;->B(JLj$/time/temporal/x;)Lj$/time/LocalDate;
    ...
    invoke-virtual {v3, v0}, Lj$/time/LocalDate;->J(Lj$/time/temporal/m;)Lj$/time/chrono/b;
    ...
    invoke-virtual {v1, v2}, Lj$/time/LocalDate;->f(Lj$/time/temporal/o;)I
