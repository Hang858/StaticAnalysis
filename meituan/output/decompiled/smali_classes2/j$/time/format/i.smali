...
.method public final a(Lj$/time/format/A;Ljava/lang/StringBuilder;)Z
    ...
    invoke-virtual {v2, v1}, Lj$/time/format/A;->e(Lj$/time/temporal/o;)Ljava/lang/Long;

    move-result-object v1

    invoke-virtual/range {p1 .. p1}, Lj$/time/format/A;->d()Lj$/time/temporal/l;

    move-result-object v3

    sget-object v4, Lj$/time/temporal/a;->NANO_OF_SECOND:Lj$/time/temporal/a;

    invoke-interface {v3, v4}, Lj$/time/temporal/l;->m(Lj$/time/temporal/o;)Z
    ...
    invoke-interface {v2, v4}, Lj$/time/temporal/l;->i(Lj$/time/temporal/o;)J
    ...
    invoke-static {v5, v6, v3, v7}, Lj$/time/LocalDateTime;->z(JILj$/time/p;)Lj$/time/LocalDateTime;
    ...
    invoke-static {v7, v8, v3, v13}, Lj$/time/LocalDateTime;->z(JILj$/time/p;)Lj$/time/LocalDateTime;
...
.method public final c(Lj$/time/format/x;Ljava/lang/CharSequence;I)I
    ...
    invoke-virtual {v0, v1, v2}, Lj$/time/format/w;->o(Lj$/time/temporal/o;I)Lj$/time/format/w;
    ...
    invoke-virtual {v0, v4, v2}, Lj$/time/format/w;->o(Lj$/time/temporal/o;I)Lj$/time/format/w;
    ...
    invoke-virtual {v0, v7, v2, v5, v8}, Lj$/time/format/w;->b(Lj$/time/temporal/o;IIZ)Lj$/time/format/w;
    ...
    invoke-virtual {v0, v5, v9, v6}, Lj$/time/format/f;->c(Lj$/time/format/x;Ljava/lang/CharSequence;I)I
    ...
    invoke-virtual {v5, v0}, Lj$/time/format/x;->j(Lj$/time/temporal/o;)Ljava/lang/Long;
    ...
    invoke-virtual {v5, v1}, Lj$/time/format/x;->j(Lj$/time/temporal/o;)Ljava/lang/Long;
    ...
    invoke-virtual {v5, v4}, Lj$/time/format/x;->j(Lj$/time/temporal/o;)Ljava/lang/Long;
    ...
    invoke-virtual {v5, v3}, Lj$/time/format/x;->j(Lj$/time/temporal/o;)Ljava/lang/Long;

    move-result-object v3

    invoke-virtual {v5, v7}, Lj$/time/format/x;->j(Lj$/time/temporal/o;)Ljava/lang/Long;
