...
.method final h()Lj$/time/chrono/f;
    .locals 1
    ...
    iget-object v0, v0, Lj$/time/format/E;->c:Lj$/time/chrono/f;

    if-nez v0, :cond_0

    iget-object v0, p0, Lj$/time/format/x;->a:Lj$/time/format/DateTimeFormatter;

    invoke-virtual {v0}, Lj$/time/format/DateTimeFormatter;->b()Lj$/time/chrono/f;
...
.method final j(Lj$/time/temporal/o;)Ljava/lang/Long;
    .locals 1
...
.method final o(Lj$/time/temporal/o;JII)I
    .locals 2
...
.method final r()V
    ...
    iget-object v3, v1, Lj$/time/format/E;->c:Lj$/time/chrono/f;

    iput-object v3, v2, Lj$/time/format/E;->c:Lj$/time/chrono/f;
...
.method final t(Lj$/time/format/F;Ljava/util/Set;)Lj$/time/temporal/l;
    .locals 2
    ...
    invoke-virtual {p0}, Lj$/time/format/x;->h()Lj$/time/chrono/f;

    move-result-object v1

    iput-object v1, v0, Lj$/time/format/E;->c:Lj$/time/chrono/f;
    ...
    invoke-virtual {v0, p1, p2}, Lj$/time/format/E;->p(Lj$/time/format/F;Ljava/util/Set;)Lj$/time/temporal/l;
