...
# direct methods
.method constructor <init>(Lj$/time/temporal/o;Lj$/time/format/H;Lj$/time/format/C;)V
    .locals 0
...
.method private b()Lj$/time/format/k;
    .locals 4
...
.method public final a(Lj$/time/format/A;Ljava/lang/StringBuilder;)Z
    ...
    invoke-interface {v1, v2}, Lj$/time/temporal/l;->k(Lj$/time/temporal/w;)Ljava/lang/Object;
    ...
    :cond_1
    iget-object v3, p0, Lj$/time/format/s;->c:Lj$/time/format/C;
    ...
    :cond_3
    :goto_0
    invoke-virtual/range {v3 .. v8}, Lj$/time/format/C;->d(Lj$/time/temporal/o;JLj$/time/format/H;Ljava/util/Locale;)Ljava/lang/String;
    ...
    invoke-virtual/range {v1 .. v6}, Lj$/time/format/C;->d(Lj$/time/temporal/o;JLj$/time/format/H;Ljava/util/Locale;)Ljava/lang/String;
    ...
    invoke-direct {p0}, Lj$/time/format/s;->b()Lj$/time/format/k;
...
.method public final c(Lj$/time/format/x;Ljava/lang/CharSequence;I)I
    ...
    invoke-virtual {v1, v2, v0, v3}, Lj$/time/format/C;->e(Lj$/time/temporal/o;Lj$/time/format/H;Ljava/util/Locale;)Ljava/util/Iterator;
    ...
    :cond_1
    iget-object v4, p0, Lj$/time/format/s;->c:Lj$/time/format/C;
    ...
    :cond_2
    invoke-virtual {v4, v5, v0, v6}, Lj$/time/format/C;->e(Lj$/time/temporal/o;Lj$/time/format/H;Ljava/util/Locale;)Ljava/util/Iterator;
