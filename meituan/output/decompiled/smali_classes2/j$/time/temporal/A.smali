...
.method private d(Lj$/time/temporal/l;)I
    .locals 2
    ...
    invoke-virtual {v0}, Lj$/time/e;->o()I
    ...
    invoke-static {p1}, Lj$/lang/a;->g(I)I
...
.method private e(Lj$/time/temporal/l;)I
    ...
    invoke-direct {p0, p1}, Lj$/time/temporal/A;->d(Lj$/time/temporal/l;)I
    ...
    invoke-interface {p1, v2}, Lj$/time/temporal/l;->f(Lj$/time/temporal/o;)I
    ...
    invoke-direct {p0, v0, v3}, Lj$/time/temporal/A;->b(II)I
    ...
    :cond_0
    invoke-interface {p1, v2}, Lj$/time/temporal/l;->g(Lj$/time/temporal/o;)Lj$/time/temporal/z;
    ...
    invoke-direct {p0, v0, v2}, Lj$/time/temporal/A;->b(II)I
...
.method private h(Lj$/time/temporal/l;)J
    .locals 2
    ...
    invoke-direct {p0, v0, p1}, Lj$/time/temporal/A;->b(II)I
...
.method private l(Lj$/time/temporal/l;)I
    .locals 4
    ...
    .line 120029
    .line 120030
    invoke-virtual {p1, v0, v1, v2}, Lj$/time/LocalDate;->x(JLj$/time/temporal/x;)Lj$/time/chrono/b;

    move-result-object p1

    invoke-direct {p0, p1}, Lj$/time/temporal/A;->l(Lj$/time/temporal/l;)I
    ...
    invoke-interface {p1, v1}, Lj$/time/temporal/l;->g(Lj$/time/temporal/o;)Lj$/time/temporal/z;
    ...
    invoke-direct {p0, v0, v1}, Lj$/time/temporal/A;->b(II)I
...
.method private n(Lj$/time/temporal/l;)J
    .locals 2
...
.method private p(Lj$/time/chrono/f;III)Lj$/time/chrono/b;
    .locals 3
    ...
    .line 1
    invoke-static {p2, p1, p1}, Lj$/time/LocalDate;->y(III)Lj$/time/LocalDate;

    move-result-object p2

    .line 2
    invoke-direct {p0, p2}, Lj$/time/temporal/A;->d(Lj$/time/temporal/l;)I
    ...
    .line 3
    invoke-virtual {p2}, Lj$/time/LocalDate;->w()Z
    ...
    .line 5
    invoke-virtual {p2, p3, p4, p1}, Lj$/time/LocalDate;->B(JLj$/time/temporal/x;)Lj$/time/LocalDate;
...
.method private u(Lj$/time/temporal/l;Lj$/time/temporal/o;)Lj$/time/temporal/z;
    .locals 3
    ...
    invoke-interface {p1, p2}, Lj$/time/temporal/l;->f(Lj$/time/temporal/o;)I
    ...
    invoke-interface {p1, p2}, Lj$/time/temporal/l;->g(Lj$/time/temporal/o;)Lj$/time/temporal/z;
    ...
    invoke-direct {p0, v0, p2}, Lj$/time/temporal/A;->b(II)I
...
.method private v(Lj$/time/temporal/l;)Lj$/time/temporal/z;
    .locals 6
    ...
    invoke-direct {p0, v1, v2}, Lj$/time/temporal/A;->b(II)I
    ...
    invoke-direct {p0, p1}, Lj$/time/temporal/A;->v(Lj$/time/temporal/l;)Lj$/time/temporal/z;
    ...
    :cond_1
    invoke-interface {p1, v0}, Lj$/time/temporal/l;->g(Lj$/time/temporal/o;)Lj$/time/temporal/z;
    ...
    invoke-direct {p0, v1, v4}, Lj$/time/temporal/A;->b(II)I
    ...
    .line 5
    invoke-virtual {p1, v0, v1, v2}, Lj$/time/LocalDate;->B(JLj$/time/temporal/x;)Lj$/time/LocalDate;
...
.method public final g(Ljava/util/Map;Lj$/time/temporal/l;Lj$/time/format/F;)Lj$/time/temporal/l;
    ...
    invoke-virtual {v3}, Lj$/time/e;->o()I
    ...
    invoke-static {v2}, Lj$/lang/a;->g(I)I
    ...
    invoke-virtual {v3, v9, v10}, Lj$/time/temporal/a;->o(J)I
    ...
    invoke-virtual {v6}, Lj$/time/e;->o()I

    move-result v6

    sub-int/2addr v4, v6

    invoke-static {v4}, Lj$/lang/a;->g(I)I
    ...
    .line 3
    invoke-static/range {p2 .. p2}, Lj$/time/chrono/d;->b(Lj$/time/temporal/l;)Lj$/time/chrono/f;
    ...
    invoke-virtual {v9, v6, v7}, Lj$/time/temporal/a;->o(J)I
    ...
    .line 5
    invoke-static {v6, v8, v8}, Lj$/time/LocalDate;->y(III)Lj$/time/LocalDate;
    ...
    .line 6
    invoke-static {v13, v14, v5, v6}, Lj$/time/c;->f(JJ)J

    move-result-wide v5

    .line 7
    invoke-virtual {v2, v5, v6, v10}, Lj$/time/LocalDate;->B(JLj$/time/temporal/x;)Lj$/time/LocalDate;

    move-result-object v2

    .line 8
    invoke-direct {v0, v2}, Lj$/time/temporal/A;->h(Lj$/time/temporal/l;)J

    move-result-wide v5

    invoke-static {v11, v12, v5, v6}, Lj$/time/c;->f(JJ)J

    move-result-wide v5

    invoke-direct {v0, v2}, Lj$/time/temporal/A;->d(Lj$/time/temporal/l;)I
    ...
    invoke-static {v5, v6, v10, v11}, Lj$/time/c;->e(JJ)J

    move-result-wide v5

    int-to-long v10, v4

    invoke-static {v5, v6, v10, v11}, Lj$/time/c;->b(JJ)J
    ...
    .line 9
    invoke-virtual {v2, v4, v5, v6}, Lj$/time/LocalDate;->B(JLj$/time/temporal/x;)Lj$/time/LocalDate;
    ...
    .line 10
    :cond_2
    invoke-virtual {v7, v13, v14}, Lj$/time/temporal/a;->o(J)I

    move-result v5

    .line 11
    invoke-static {v6, v5, v8}, Lj$/time/LocalDate;->y(III)Lj$/time/LocalDate;
    ...
    invoke-virtual {v6, v11, v12, v0}, Lj$/time/temporal/z;->a(JLj$/time/temporal/o;)I

    move-result v6

    int-to-long v10, v6

    invoke-direct {v0, v5}, Lj$/time/temporal/A;->h(Lj$/time/temporal/l;)J
    ...
    invoke-direct {v0, v5}, Lj$/time/temporal/A;->d(Lj$/time/temporal/l;)I
    ...
    .line 13
    invoke-virtual {v5, v10, v11, v4}, Lj$/time/LocalDate;->B(JLj$/time/temporal/x;)Lj$/time/LocalDate;
    ...
    invoke-virtual {v4, v7}, Lj$/time/LocalDate;->i(Lj$/time/temporal/o;)J
    ...
    sget-object v10, Lj$/time/temporal/b;->YEARS:Lj$/time/temporal/b;
    ...
    invoke-direct {v0, v5}, Lj$/time/temporal/A;->n(Lj$/time/temporal/l;)J

    move-result-wide v6

    invoke-static {v10, v11, v6, v7}, Lj$/time/c;->f(JJ)J
    ...
    invoke-static {v6, v7, v10, v11}, Lj$/time/c;->b(JJ)J
    ...
    .line 18
    invoke-virtual {v5, v6, v7, v2}, Lj$/time/LocalDate;->B(JLj$/time/temporal/x;)Lj$/time/LocalDate;
    ...
    invoke-virtual {v7, v10, v11, v0}, Lj$/time/temporal/z;->a(JLj$/time/temporal/o;)I
    ...
    .line 20
    invoke-virtual {v5, v7, v8, v4}, Lj$/time/LocalDate;->B(JLj$/time/temporal/x;)Lj$/time/LocalDate;
    ...
    invoke-virtual {v4, v9}, Lj$/time/LocalDate;->i(Lj$/time/temporal/o;)J
    ...
    invoke-static {v9}, Lj$/time/temporal/B;->c(Lj$/time/temporal/B;)Lj$/time/temporal/o;
    ...
    invoke-static {v11}, Lj$/time/temporal/B;->c(Lj$/time/temporal/B;)Lj$/time/temporal/o;

    move-result-object v11

    invoke-virtual {v5, v9, v10, v11}, Lj$/time/temporal/z;->a(JLj$/time/temporal/o;)I
    ...
    invoke-direct {v0, v6, v5, v8, v4}, Lj$/time/temporal/A;->p(Lj$/time/chrono/f;III)Lj$/time/chrono/b;
    ...
    .line 26
    invoke-virtual {v2, v4, v5, v7}, Lj$/time/LocalDate;->B(JLj$/time/temporal/x;)Lj$/time/LocalDate;
    ...
    invoke-direct {v0, v6, v5, v7, v4}, Lj$/time/temporal/A;->p(Lj$/time/chrono/f;III)Lj$/time/chrono/b;
    ...
    invoke-direct {v0, v4}, Lj$/time/temporal/A;->e(Lj$/time/temporal/l;)I
...
.method public final i(Lj$/time/temporal/l;)J
    ...
    invoke-direct {p0, p1}, Lj$/time/temporal/A;->h(Lj$/time/temporal/l;)J
    ...
    invoke-direct {p0, p1}, Lj$/time/temporal/A;->n(Lj$/time/temporal/l;)J
    ...
    invoke-direct {p0, p1}, Lj$/time/temporal/A;->e(Lj$/time/temporal/l;)I
...
.method public final k(Lj$/time/temporal/k;J)Lj$/time/temporal/k;
    ...
    invoke-interface {p1, p0}, Lj$/time/temporal/l;->f(Lj$/time/temporal/o;)I
    ...
    invoke-direct {p0, p1, p3, v1, v0}, Lj$/time/temporal/A;->p(Lj$/time/chrono/f;III)Lj$/time/chrono/b;
    ...
    invoke-interface {p1, p2, p3, v0}, Lj$/time/temporal/k;->j(JLj$/time/temporal/x;)Lj$/time/temporal/k;
...
.method public final m(Lj$/time/temporal/l;)Lj$/time/temporal/z;
    ...
    invoke-direct {p0, p1, v0}, Lj$/time/temporal/A;->u(Lj$/time/temporal/l;Lj$/time/temporal/o;)Lj$/time/temporal/z;
    ...
    invoke-virtual {p1}, Lj$/time/temporal/a;->c()Lj$/time/temporal/z;
