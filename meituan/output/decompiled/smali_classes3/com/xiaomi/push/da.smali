...
.method public static a(Lcom/xiaomi/push/hh;)I
    .locals 0

    invoke-virtual {p0}, Lcom/xiaomi/push/hh;->a()I
...
.method public static a(Lcom/xiaomi/push/is;Lcom/xiaomi/push/hh;)I
    .locals 2
    ...
    :pswitch_0
    invoke-virtual {p1}, Lcom/xiaomi/push/hh;->a()I
    ...
    invoke-virtual {p0}, Lcom/xiaomi/push/ic;->b()Ljava/lang/String;
    ...
    invoke-static {p0}, Lcom/xiaomi/push/ex;->a(Ljava/lang/String;)I
    ...
    :try_start_1
    instance-of v0, p0, Lcom/xiaomi/push/hy;

    if-eqz v0, :cond_2

    check-cast p0, Lcom/xiaomi/push/hy;

    iget-object p0, p0, Lcom/xiaomi/push/hy;->d:Ljava/lang/String;
    ...
    invoke-static {p0}, Lcom/xiaomi/push/em;->a(Ljava/lang/String;)Lcom/xiaomi/push/hr;
    ...
    :cond_2
    instance-of v0, p0, Lcom/xiaomi/push/ig;

    if-eqz v0, :cond_1

    check-cast p0, Lcom/xiaomi/push/ig;

    iget-object p0, p0, Lcom/xiaomi/push/ig;->d:Ljava/lang/String;
...
.method public static a(Ljava/lang/String;Landroid/content/Context;Lcom/xiaomi/push/id;I)V
    .locals 2
    ...
    :cond_0
    invoke-virtual {p2}, Lcom/xiaomi/push/id;->a()Lcom/xiaomi/push/hh;

    move-result-object v0

    if-eqz v0, :cond_3

    invoke-static {v0}, Lcom/xiaomi/push/da;->a(Lcom/xiaomi/push/hh;)I
...
.method public static a(Ljava/lang/String;Landroid/content/Context;Lcom/xiaomi/push/is;Lcom/xiaomi/push/hh;I)V
    .locals 0

    invoke-static {p2, p3}, Lcom/xiaomi/push/da;->a(Lcom/xiaomi/push/is;Lcom/xiaomi/push/hh;)I
...
.method public static a(Ljava/lang/String;Landroid/content/Context;[B)V
    ...
    :try_start_0
    invoke-static {v0, p2}, Lcom/xiaomi/push/ir;->a(Lcom/xiaomi/push/is;[B)V

    array-length p2, p2

    invoke-static {p0, p1, v0, p2}, Lcom/xiaomi/push/da;->a(Ljava/lang/String;Landroid/content/Context;Lcom/xiaomi/push/id;I)V
    :try_end_0
